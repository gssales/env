...
__posh_git_echo () {
    ...
    local BeforeText=' ['
    local BeforeForegroundColor=$(__posh_color $Blue) # Edited to Blue, Default Yellow
    ...
    local AfterText=']'
    local AfterForegroundColor=$(__posh_color $Blue) # Edited to Blue, Default Yellow
    local AfterBackgroundColor=

    local BranchForegroundColor=$(__posh_color $Blue)  # Edited to Blue, Default Cyan
